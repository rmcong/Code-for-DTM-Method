...
RandStream.setDefaultStream(RandStream('mrg32k3a','Seed',opts.seed));
...
%     detector.opts.pPyramid.lambdas=ls;
    detector.opts.pPyramid.lambdas= [0,0.1043,0.1043,0];
...
dfs= { 'pPyramid',{}, 'modelDs',[100 41], 'modelDsPad',[128 64], ...
  ...
  'imreadf',@imread, 'imreadp',{}, 'pLoad',{}, 'nPos',inf, 'nNeg',2000, ...
...
if( exist(crDir,'dir') && stage==0 )
  ...
  Is=cell(1,n); for i=1:n, Is{i}=feval(fs{i}{:}); Is{i}=imresize(Is{i},opts.modelDsPad); end
else
